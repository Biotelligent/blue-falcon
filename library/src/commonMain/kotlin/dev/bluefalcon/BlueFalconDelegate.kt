...
interface BlueFalconDelegate {
    ...
    @JsName("didCharacteristicValueChanged")
    ...
    fun didReadDescriptor(bluetoothPeripheral: BluetoothPeripheral, bluetoothCharacteristicDescriptor: BluetoothCharacteristicDescriptor)

    @JsName("didWriteDescriptor")
    fun didWriteDescriptor(bluetoothPeripheral: BluetoothPeripheral, bluetoothCharacteristicDescriptor: BluetoothCharacteristicDescriptor)

    @JsName("didWriteCharacteristic")
    fun didWriteCharacteristic(bluetoothPeripheral: BluetoothPeripheral, bluetoothCharacteristic: BluetoothCharacteristic, success: Boolean)
}